...
<head>
    ...
    <title>LisboaADM - EditarCupom</title>
    ...
    <main>
        <div class="container">
            <div class="card">
                ...
                <form action="{{ route('processCupomEdit', ['id' => $cupom->id]) }}" method="post" id="couponForm">
                    @csrf
                    @method('PUT')
                    <!-- Código -->
                    <div class="field">
                        ...
                        <div class="flex">
                            <input type="text" id="code" placeholder="EX: DESCONTO2025" maxlength="24" name="cupom" value="{{ $cupom->cupom }}" required>
                        ...
                        <div class="flex">
                            <input type="text" id="quantidade_minima" placeholder="Quantidade" maxlength="24" name="quantidade_minima" value="{{ $cupom->quantidade_minima }}" required>
                        </div>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <div class="slider-container">
                            <input type="range" id="discountRange" min="0" max="100" value="{{ $cupom->desconto }}">
                            <input type="number" id="discount" min="0" max="100" value="{{ $cupom->desconto }}" name="desconto">
                        </div>
                    </div>
